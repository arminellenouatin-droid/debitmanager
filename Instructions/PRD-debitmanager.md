...
# Projet : DebitManager (Bar Maquis Master)
### Plateforme SaaS mobile & web de gestion de bars, maquis, restaurants, boîtes de nuit et lounges

**Version :** 1.0
**Statut :** Prêt pour développement
**Destinataires :** Équipe produit, agents IA de développement (conception, backend, frontend, mobile, DevOps, QA)
...
4. Périmètre du produit (in/out of scope)
...
Le produit doit être conçu pour un contexte de connectivité instable et d'utilisateurs finaux parfois peu ou pas lettrés : simplicité extrême, usage massif d'icônes/couleurs, fonctionnement hors-ligne robuste.
...
**Revenu 1 — Abonnement récurrent des boutiques**
...
*(Détail complet de chaque module, règles de gestion précises et parcours utilisateurs : voir le cahier des charges technique.)*
...
**Gestion Super-Admin du programme :** configuration globale des taux/modes, validation/suspension des affiliés, traitement des demandes de retrait, rapports de coût et de ROI du programme (voir section 9).
...
*(Détail complet : voir le cahier des charges technique, section 4 et modèle de données section 5.)*
...
*(Détail complet : voir le cahier des charges technique, section 12.)*
...
Choix définitif de la stack, schéma de données détaillé, maquettes UI validées.

**Phase 1 — MVP**
Inscription/authentification, abonnement + paiement, configuration boutique, produits/stocks de base, prise de commande simple, paiement espèces.

**Phase 2 — Opérations avancées**
Paiement carte/mobile money, badgeage/présence géolocalisé, gestion des tables, workflow cuisine/bar (KDS), mode hors-ligne.

**Phase 3 — Gestion & finance**
Paie complète, trésorerie, comptabilité, approvisionnements/fournisseurs, inventaire physique.

**Phase 4 — Pilotage, communication & croissance**
KPI et dashboards complets, messagerie interne, notifications multi-canal, primes automatiques, **lancement du programme d'affiliation** et du **dashboard Super-Admin complet**.
...
*Fin du PRD. Ce document définit le "quoi" et le "pourquoi" du produit ; le cahier des charges technique définit le "comment" en détail.*
