# BACKLOG DÉTAILLÉ — SPRINT PAR SPRINT
# Projet : DebitManager
...
**Rappel — Definition of Done globale (s'applique à chaque ticket en plus de ses critères propres) :** fonctionne en ligne et hors-ligne quand applicable · traduit (i18n) · respecte la matrice de permissions · couvert par des tests automatisés · responsive mobile/tablette/web · génère une entrée d'audit si action sensible · validé sur appareil bas de gamme en 2G/3G simulée.
