...
### Application SaaS mobile & web de gestion de bars, maquis, restaurants, boîtes de nuit et lounges
...
Entités clés à modéliser (liste non exhaustive, les agents doivent compléter le schéma relationnel détaillé lors de la conception technique) :
...
- Gestion du contenu global (CGU, politique de confidentialité, FAQ, notifications diffusées à toutes les boutiques)
...
*Fin du cahier des charges. Ce document doit être considéré comme la source de vérité fonctionnelle du projet ; toute ambiguïté rencontrée en cours de développement doit être résolue en cohérence avec les principes directeurs énoncés en section 2 et 14.1.*
