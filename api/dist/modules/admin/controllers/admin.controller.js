...
let AdminController = class AdminController {
    ...
    async getCompanies(page, limit, status) {
        return this.adminService.getCompanies(page ? parseInt(page) : 1, limit ? parseInt(limit) : 20, status);
    }
    async getSubscriptions(page, limit, status) {
        return this.adminService.getSubscriptions(page ? parseInt(page) : 1, limit ? parseInt(limit) : 20, status);
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminController.prototype, "suspendCompany", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "activateCompany", null);
