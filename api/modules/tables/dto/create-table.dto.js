...
class CreateTableDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, capacity: { required: true, type: () => Number }, status: { required: false, type: () => Object }, location: { required: false, type: () => String } };
    }
}
...
__decorate([
    (0, class_validator_1.IsEnum)(['AVAILABLE', 'OCCUPIED', 'RESERVED']),
